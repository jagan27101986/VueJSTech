...
<div class="list-property">
          ...
          <div class="list-row-item" v-if=" countdown.seconds > 0"><div class="list-property-name"> Race Countdown </div>  {{countdown.minutes}} m {{countdown.seconds}} s  </div>
          <div class="list-row-item" v-else-if="countdown.seconds < 0 "><div class="list-property-name"> Race Status </div> Started</div>
</div>
</div>
</template>
